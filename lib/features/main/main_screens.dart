...
/// SpeakScreen now owns the always-on ConversationSessionController
/// directly (no wake-word gating — see Step 1 of the rebuild plan), so
/// Home is just a thin wrapper around it.
