...
abstract final class AppRoutes {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    return PageRouteBuilder(settings: settings, pageBuilder: (_, a, __) => FadeTransition(opacity: CurvedAnimation(parent: a, curve: Curves.easeOutCubic), child: page), transitionDuration: const Duration(milliseconds: 260));
  }
}
