...
import '../../features/main/guided_navigation_screen.dart';
...
abstract final class AppRoutes {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    final Widget page = switch (settings.name) {
      ...
      '/read' => const ReadScreen(), '/navigate' => const GuidedNavigationScreen(), '/camera-capture' => const CameraCaptureScreen(), '/indoor-navigation' => const IndoorNavigationScreen(), '/travel' => const TravelScreen(),
